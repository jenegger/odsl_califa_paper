...
\author[1]{L. Heinrich}
\address[1]{{Technische Universität München},%Department and Organization
            {James-Franck-Str 1}, 
            {Garching b. München},
            {85748},
            {Germany}}
...
The work was supported by BMBF 05P24WO2 and Excellence Cluster ORIGINS from the DFG (Excellence Strategy EXC-2094-390783311). It was made possible through the close collaboration of experts from diverse disciplines within the Cluster of Excellence ORIGINS~\cite{origins2025}.
